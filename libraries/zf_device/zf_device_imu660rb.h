...
#define IMU660RB_SPC_PIN                            (SPI2_SCLK_P15_8)          // 硬件 SPI SCK 引脚
#define IMU660RB_SDI_PIN                            (SPI2_MOSI_P15_6)          // 硬件 SPI MOSI 引脚
#define IMU660RB_SDO_PIN                            (SPI2_MISO_P15_4)          // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define IMU660RB_CS_PIN                             (P15_2)                    // CS 片选引脚
