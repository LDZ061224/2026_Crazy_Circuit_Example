...
void Get_Error(void)
{
	...
	if (First_Mode == 0)
    {
        ...
        Element_nums = Run_Track.Arr_Element_Num[Execute_Times];
				...
				// }
			// 动态速度调整
       Run_Track.Speed_Adjust.Range_Target[0] = L_exp;
       Run_Track.Speed_Adjust.Range_Target[1] = R_exp ;
...
//	}
	...
	HAL_GPIO_WritePin (GPIOC , GPIO_PIN_0, 0);
		...
		Count.Node_Mileage += (0.7 * Average_Speed + 0.3 * Last_Average_Speed);
    if (Track_Num < 2)
    {
